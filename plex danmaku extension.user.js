...
function initButton(){
    var menubar=document.querySelector("div[class='PlayerControls-buttonGroupCenter-9NAbcp PlayerControls-buttonGroup-22pcMw PlayerControls-balanceLeft-3rSLHI']")
...
function actionFunction (is_init=true) {
    ...
    var ori_anime=document.querySelector("a[class='MetadataPosterTitle-singleLineTitle-18uV9h MetadataPosterTitle-title-2tTQZd Link-link-3cHWtJ Link-default-5Qrl3D']").innerHTML
    var anime= ori_anime
        ...
        onload: function(response){
            ...
            GM_xmlhttpRequest({
                ...
                onload: function(response2){
                    ...
                    new ResizeObserver(() => {
                        if(!document.querySelector("div[class='Player-fullPlayerContainer-3cCUBp']")){
                        danmaku.destroy();
                            reload();
                        }
...
(function() {
    'use strict';
    waitForKeyElements ("div[class='Player-fullPlayerContainer-3cCUBp']",wait1);
    // Your code here...
})();
